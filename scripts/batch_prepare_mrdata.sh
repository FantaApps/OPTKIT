...
python process_data_conf.py ../data/stmodel/DC/BURGLARY      ../data/experiment/mapreduce/DC_BUR_CONF 128
python process_data_conf.py ../data/stmodel/DC/ROBBERY       ../data/experiment/mapreduce/DC_ROB_CONF 128
python process_data_conf.py ../data/stmodel/DC/LARCENY_THEFT ../data/experiment/mapreduce/DC_TFT_CONF 128
...
python process_data_conf.py ../data/stmodel/CHI/BURGLARY      ../data/experiment/mapreduce/CHI_BUR_CONF 128
python process_data_conf.py ../data/stmodel/CHI/ROBBERY       ../data/experiment/mapreduce/CHI_ROB_CONF 128
python process_data_conf.py ../data/stmodel/CHI/THEFT         ../data/experiment/mapreduce/CHI_TFT_CONF 128
...
python process_data_conf.py ../data/stmodel/NY/BURGLARY      ../data/experiment/mapreduce/NY_BUR_CONF 128
python process_data_conf.py ../data/stmodel/NY/ROBBERY       ../data/experiment/mapreduce/NY_ROB_CONF 128
python process_data_conf.py ../data/stmodel/NY/GRAND_LARCENY ../data/experiment/mapreduce/NY_TFT_CONF 128
